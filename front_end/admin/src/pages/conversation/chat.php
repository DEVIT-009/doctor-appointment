          ...
          <div class="navbar">
            <div class="user-details mr-auto">
              ...
              <div class="user-info float-left">
                <a href="profile.html"
                  ><span class="font-bold">Jennifer Robinson</span>
            ...
            <ul class="nav custom-menu">
              ...
              <li class="nav-item">
                <a class="nav-link" href="index.php?page=conversation&voice_call"
                  ><i class="fa fa-phone"></i
                ></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="index.php?page=conversation&video_call"
      ...
      <div class="chat-window video-window">
        <div class="fixed-header">
          <ul class="nav nav-tabs nav-tabs-bottom">
            <li class="nav-item">
              <a class="nav-link" href="#calls_tab" data-toggle="tab"
                >Calls</a
              >
            </li>
            <li class="nav-item">
                  ...
                  <div class="chat chat-left">
                    <div class="chat-avatar">
                      <a href="profile.html" class="avatar">
                        <img
                          alt="Cristina Groves"
                          src="assets/img/doctor-thumb-03.jpg"
                          class="img-fluid rounded-circle"
                        />
                      </a>
                    </div>
                ...
                <div class="table-body">
                  <div class="table-content">
                    <div class="chat-profile-img">
                      ...
                      <h3 class="user-name m-t-10 mb-0">
                        Cristina Groves
                      </h3>
                    ...
                    <div class="chat-profile-info">
                      <ul class="user-det-list">
                        ...
                        <li>
                          <span>Email:</span>
                          <span class="float-right text-muted"
                            >cristinagroves@example.com</span
                          >
                        </li>
                        <li>
                          <span>Phone:</span>
