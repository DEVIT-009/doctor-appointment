            ...
            <div class="navbar">
              <div class="user-details mr-auto">
                ...
                <div class="user-info float-left">
                  <a href="profile.html" title="Jennifer Robinson"
                    ><span class="font-bold">Jennifer Robinson</span></a
                  >
              ...
              <ul class="nav float-right custom-menu">
                <li class="nav-item">
                  <a
                    class="task-chat profile-rightbar float-right"
                    href="#chat_sidebar"
                    id="task_chat"
              ...
              <div class="call-users">
                <ul>
                  ...
                  <li>
                    <a href="#">
                      <img
                        src="assets/img/patient-thumb-02.jpg"
                        class="img-fluid"
                        alt=""
                      />
                      <span class="call-mute"
                  ...
                  <li>
                    <a href="#">
                      <img
                        src="assets/img/patient-thumb-01.jpg"
                        class="img-fluid"
                        alt=""
                      />
                      <span class="call-mute"
        ...
        <div class="chat-window video-window">
          <div class="fixed-header">
            <ul class="nav nav-tabs nav-tabs-bottom">
              <li class="nav-item">
                <a class="nav-link active" href="#calls_tab" data-toggle="tab"
                  >Calls</a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#chats_tab" data-toggle="tab"
                  >Chats</a
                >
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#profile_tab" data-toggle="tab"
                  >Profile</a
                >
              </li>
            </ul>
                        ...
                        <div class="chats">
                          ...
                          <div class="chat chat-left">
                            ...
                            <div class="chat-body">
                              <div class="chat-bubble">
                                <div class="chat-content">
                                  <span class="chat-user">Jeffery Lalor</span>
                                  <span class="file-attached"
                                    >attached file
                                    <i class="fa fa-paperclip"></i
                                  ></span>
